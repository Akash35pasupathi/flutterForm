...
class MyHomePage extends StatelessWidget {
  ...
  MyHomePage({Key key, this.title, this.gleAccount}) : super(key: key);
    ...
    return FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            dashboardList = snapshot.data[0]['table_menu_list'];
                  ...
                  appBar: new AppBar(
                    ...
                    bottom: TabBar(
                      ...
                      tabs: new List<Widget>.generate(
                        ...
                        (int index) {
                          return Tab(
                            text: dashboardList[index]['menu_category'],
                          );
                        },
                      ),
                    ),
                  ...
                  body: SafeArea(
                    child: TabBarView(
                      ...
                      children: new List<Widget>.generate(
                        ...
                        (int index) {
                          return Center(
                            child: tabListWidget(dashboardList[index]),
                          );
                        },
                      ),
                    ),
...
Widget tabListWidget(dynamic listData) {
  return new ListView.builder(
      itemCount: listData['category_dishes'].length,
                    ...
                    children: [
                      Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                listData['category_dishes'][index]['dish_name'],
                                style: TextStyle(
                              ...
                              Row(
                                ...
                                children: [
                                  Flexible(
                                      flex: 1,
                                      child: Text(
                                        "SAR ${listData['category_dishes'][index]['dish_price']}",
                                        style: TextStyle(
                                            fontSize: 12,
                                  ...
                                  Flexible(
                                      flex: 1,
                                      child: Text(
                                        "${listData['category_dishes'][index]['dish_calories']} Calories",
                                        style: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold),
                                      ))
                              ...
                              Divider(),
                              Text(
                                listData['category_dishes'][index]
                                    ['dish_description'],
                                style: TextStyle(
                                    fontSize: 12,
                      ...
                      Flexible(
                          flex: 1,
                          child: Image.network(
                            listData['category_dishes'][index]['dish_image'],
                            fit: BoxFit.fill,
                          ))
                    ],
                  ),
